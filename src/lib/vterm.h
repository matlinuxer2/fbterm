...
private:
		...
		static const StateOption control_state[], esc_state[], square_state[], nonstd_state[], 
							percent_state[], hash_state[], charset_state[], funckey_state[];
		...
		//history
		static const u16 history_lines;
		bool history_full;
